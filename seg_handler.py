...
class SegHandler:
    ...
    def init_screen_range(self) -> set[int]:
        return set(range(WIDTH))

    def update_screen_range(self):
    ...
    def clip_portal_walls(self, x_start, x_end):
        curr_wall: set[int] | None = set(range(x_start, x_end))
        #
